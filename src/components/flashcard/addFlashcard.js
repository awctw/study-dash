...
import { Button, Card, CardBody, Dialog, IconButton, Input, Textarea, Tooltip, Typography } from "@material-tailwind/react";
    ...
    return (
        <>
            <Card className="w-full h-full object-cover bg-transparent items-center justify-center rounded-none">
                ...
                <Dialog open={visible} handler={setVisible} size="sm" className="flex flex-row bg-transparent shadow-none items-center justify-center">
                    <Card className="relative flex w-2/3 rounded-lg overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-xl scrollbar-thumb-blue-gray-100">
                        <CardBody className="mb-2">
                            ...
                            <Typography className="mb-3">
                                Please enter a question and answer that will be associated with this flashcard. 
                            </Typography>
